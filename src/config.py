...
# Aim settings
AIM_SPEED = 2  # Mouse sensitivity multiplier

SHOOT_COOLDOWN = 0.2
BODY_OFFSET = 0.1  # Distance from top of box to aim (0.0=top, 0.5=center, 0.2=neck)
HEAD_OFFSET = 0.1 # Distance from top of head box (0.0=top, 0.5=center, 0.15=forehead)
